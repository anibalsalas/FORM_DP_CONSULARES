...
@Directive({
  selector: '[appMax8Digits]',
  standalone: true
})
export class Max8DigitsDirective {
  private readonly MAX = 8;

  // Sugerir teclado numérico y ayudar a validación del navegador
  @HostBinding('attr.inputmode') inputmode = 'numeric';
  // patrón “0 a 8 dígitos”
  @HostBinding('attr.pattern') pattern = '\\d{0,8}';
  // refuerzo para navegadores que respetan maxlength
  ...
  /** Pegar: filtra a dígitos y recorta a 8 */
